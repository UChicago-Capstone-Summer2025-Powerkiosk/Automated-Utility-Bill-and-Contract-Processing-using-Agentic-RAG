...
if __name__ == "__main__":
    print("--- Starting PDF-to-Generic-JSON Pilot ---")
    ...
    # Find the PDFs directly in the source folder (not recursively for this simple pilot)
    ...
    if not pdf_files:
        ...
        try:
            print("\nProcessing documents with agentic-doc...")
            ...
            for source_path, parsed_doc in zip(pdf_files, results):
                ...
                # The .chunks attribute contains the generic structured data.
                # We convert each chunk object to a standard dictionary for JSON serialization.
