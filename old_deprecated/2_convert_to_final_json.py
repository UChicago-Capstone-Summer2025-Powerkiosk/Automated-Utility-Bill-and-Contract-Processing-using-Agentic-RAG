...
FINAL_JSON_DIR = "final_pdf_json_outputs/" # A new folder for the final product
        ...
        for filename in json_files:
            ...
            try:
                ...
                response = client.chat.completions.create(
                    model="gpt-4o", # Using the best model for this complex task
