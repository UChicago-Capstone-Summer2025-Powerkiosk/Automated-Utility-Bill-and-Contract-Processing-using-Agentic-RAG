...
Material Consumption Variance. The contract quantities (Total, Annual and Monthly) reflected on this TC are agreed by the Parties to be reflective of Customer's forecasted Energy consumption. If during the Delivery Period, Customer's actual metered consumption during three (3) consecutive months increases or decreases from the Monthly Contract Quantity for the applicable months reflected on this TC by $25 \%$ or more (in each instance a "Material Consumption Variance" or "MCV"), then Seller may charge Customer for the purchase of, or liquidation of, Energy and related services including transmission and capacity, bought or sold as a result of the MCV and Customer agrees to pay same.
...
"Hold-over Rate" means the applicable day ahead LMP, plus all applicable pass throughs, plus \$10/MWh. Pass throughs or pass through charges are all costs incurred by MP2 to supply Energy to Customer hereunder regardless of whether such costs were included in the Contract Price or treated as a pass through prior to the Renewal Period.
...
| Wholesale Price of Energy <br> Basis from Hub to the Load Zone <br> Capacity <br> Capacity Performance <br> Capacity Transfer Rights <br> Network Integration Transmission Service <br> Transmission Enhancement Charge <br> Transmission Enhancement Credit <br> Dist., Trans., UFE \& Deration Losses <br> Renewable Portfolio Standard Obligations <br> ARRs <br> Generation Deactivation aka RMR <br> Transmission Loss Credits <br> Balancing Congestion | Ancillary Services: <br> Synchronized Reserves <br> Non-Synchronize Reserves <br> Regulation and Frequency Response <br> Service <br> Black Start <br> DA Scheduling Reserves <br> Reactive Services <br> Trans. Owner Scheduling (Schd. 1A) <br> Reactive \& Voltage from Gen Svc <br> DA Operating Reserve <br> Balancing Operating Reserve <br> DA Load Response Allocation <br> RT Load Response Allocation | Control Area Administration <br> FTR Administration <br> Market Support <br> Capacity Resource and Obligation Mgmt <br> FERC Annual Charge Recovery <br> Market Monitoring Unit (MMU) Funding <br> Organization of PJM States, Inc Funding <br> PJM Settlement: Market Support <br> NURC Corporation Charge <br> Reliability First Corporation Charge <br> Inadvertent Interchange <br> Meter Error Correction |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |

## EXHIBIT C Pass-through Charges (passed to Customer at cost)

EDC Delivery Charges
...
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| Delv. Pt\# | Account Number | Service Address | City, State, Zip | Utility | Method of <br> Billing | Meter Read <br> Date/Special <br> Date |
| I | 1033781011 | 909 Tower Rd | Long Grove, IL 60060 | CMD | UCB | 08/01/2020 |

## BIO PACKAGING FILMS, LLC

By: $\qquad$
Name: Gennady Brivoruchko
Title:
...
| PJM | VA | Rappelumnock Coop | 800-552-3904 |
