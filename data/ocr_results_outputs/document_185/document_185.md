...
The image is a photo or scanned document with text that is mostly illegible due to poor quality. The visible text at the bottom includes:
...
The rest of the text is too faint to read clearly.
...
The image is a photo of a table document. The table is titled "EXHIBIT D PERCENT FIXED WITH INDEX" and includes several columns and rows with the following details:

- **Columns on the left:**
  - "Time Period (Hours)" with "All Hour" listed below.
  - "Shaped Block 1" with "Shaped Block Price ($/MWh)" showing "$36.97".
  - "Shaped Block 2", "Shaped Block 3", and "Shaped Block 4" with empty cells for "Shaped Block Price ($/MWh)" and "Time Period Percentage Per".
...
- **Customer Location Information:**
  - Columns include "#", "CUSTOMER NAME", "CUSTOMER LOCATION ADDRESS", "CITY", "ST", "ZIP", "ESID", and "COMMENCEMENT DATE".
  - Rows show:
    - "1", "Dallas Armotive Inc", "900 INDUSTRIAL BLVD STE 125", "GRAPEVINE", "TX", "76051", "10443720000557986", "4/1/2019"
    - "2", "Dallas Armotive Inc", "2988 W WALNUT HILL LN B/C", "DFW AIRPORT", "TX", "75261", "10443720000574142", "4/1/2019"
    - "3", "Dallas Armotive Inc", "2988 W WALNUT HILL LN B/C", "DFW AIRPORT", "TX", "75261", "10443720000634421", "4/1/2019"
    - "4", "Dallas Armotive Inc", "2988 W WALNUT HILL LN A", "DFW AIRPORT", "TX", "75261", "10443720000934661", "4/1/2019"
    - "5", "Dallas Armotive Inc", "909 NOLEN DR", "GRAPEVINE", "TX", "76051", "1044372000097423", "4/1/2018"

- Handwritten notes on the left side read "5/1 - 6/1" and "5/1/24".

The table is organized with customer information on the right and pricing details on the left. Purple lines highlight certain rows in the customer information section.
...
The image is a photo showing a section of a utility bill or statement. It contains the following text:
...
The image is a photo or illustration of a QR code. There is no additional text or elements visible within the image itself.
...
Email us at: solutions@reliant.com Visit our website: reliant.com/largebusiness
For service order requests call 1-688-313-6862 PUCT Certificate 10007
...
- "City Sales Tax"
- "State Sales Tax"
- "Total Taxes and" (with "Total Taxes and" underlined)
- "Current Charge"
...
## $m \mathrm{~m} / \mathrm{m}$ m m

$m \mathrm{~m} / \mathrm{m}$ m m
$m \mathrm{~m} / \mathrm{m}$ m m
$m \mathrm{~m} / \mathrm{m}$ m m m
$m \mathrm{~m} / \mathrm{m}$ m m m
$m \mathrm{~m} / \mathrm{m}$ m m m m
$m \mathrm{~m} / \mathrm{m}$ m m m m
$m \mathrm{~m} / \mathrm{m}$ m m m m
$m \mathrm{~m} / \mathrm{m}$ m m m m m
Q1001001001010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101010101
...
- The top left corner contains the Reliant logo with the text "an NRG company" and the address "Reliant P.O. Box 1532 HOUSTON TX 77251-1532."
- Below is a sequence of numbers and letters: ">000024 3147364 0002 008164 10Z."
- The recipient's address is "DALLAS AIRMOTIVE INC 1211 STATE ROAD 436 #295 CASSELBERRY FL 32707-6442."
- On the right side, it shows "Account: 12 019 381 - 8."
- There is a section for "AMOUNT PAID $: ________________."
- The "Date Due" is "07/16/2021."
- The "Amount Due" is "$ 6,135.21."
- The "Invoice Number" is "117 008 480 587 8."
- The bottom right corner has "Mail payment to: RELIANT, DEPT 0954 PO BOX 120954 DALLAS TX 75312-0954."
- There are barcode-like lines at the bottom of the image.
