...
068534000040838
$\left.\mathrm{If} \mid \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}|\mathrm{H}_{\mathrm{f}}| \mathrm{H}_{\mathrm{f}} \mathrm{f} \mid \mathrm{f} \mathrm{f}$ HOTEL WOODBRIDGE LLC
120 WOOD AVE S
...
068534000040838
$\left.\mathrm{If} \mid \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}| | \mathrm{H}_{\mathrm{f}}|\mathrm{H}_{\mathrm{f}}| \mathrm{f}$ PSE\&G CO
PO BOX 14444
...
- **Y-Axis (Right)**: Unlabeled but corresponds to the line graph.
- **Legend**:
  - Orange bars represent "Total energy used."
  - A gray line represents "Highest Measured Demand each month."
  - "E" indicates an "Estimated reading."
- **Data Points**: 
  - The bars show varying heights each month, indicating different levels of energy usage.
...
The bars are orange, and the line is gray, with the estimated reading marked by "E."
...
The image is a photo or illustration of a blank white page with a small text in the top right corner. The text reads: "ia.jpeg | 106010.jpg:bill.202302221117 sr=137070-000040838". There are no other visible elements or features on the page.
...
- **Legend**:
  ...
  - "E": "Estimated reading"
- **Data Points**:
  - Each month has an orange bar indicating the total energy used in kWh.
  - A gray line indicates the highest measured demand in kW for each month.
- **Styling**:
  - The bars are consistently orange.
  - The line is gray and runs across the top of the bars.
- **Notable Features**:
  - The chart shows a consistent pattern of energy use with some fluctuations in demand.
...
The image is a bar chart with a line graph overlay, titled "Your monthly electric use." It provides a **yearly usage breakdown (monthly-based)** from September 2022 to September 2023. 

- **Y-axis (left):** Measures energy in kWh, ranging from 0 to 150,000.
- **Y-axis (right):** Measures demand in kW, ranging from 0 to 600.
...
The bars show monthly energy usage, while the line indicates the highest demand each month. The chart uses orange for the bars and gray for the line.
...
- **Legend Entries**:
  ...
  - "E" indicates "Estimated reading"
- **Data Points**:
  - Sep 2022: Approximately 50,000 kWh
  - Oct 2022: Approximately 55,000 kWh (Estimated)
  - Nov 2022: Approximately 50,000 kWh (Estimated)
  - Dec 2022: Approximately 45,000 kWh (Estimated)
  - Jan 2023: Approximately 30,000 kWh
  - Feb 2023: Approximately 25,000 kWh
  - Mar 2023: Approximately 35,000 kWh
  - Apr 2023: Approximately 40,000 kWh
  - May 2023: Approximately 45,000 kWh
  - Jun 2023: Approximately 50,000 kWh
  - Jul 2023: Approximately 50,000 kWh
  - Aug 2023: Approximately 50,000 kWh
  - Sep 2023: Approximately 55,000 kWh
- **Notable Styling**: 
  - The bars are orange.
  - The line is grey.
  - "E" is marked above certain bars indicating estimated readings.
...
- **Legend Entries**:
  ...
  - "E" indicates "Estimated reading."
- **Data Points**:
  - The bars show varying energy usage each month, with a noticeable increase in usage in the summer months (July, August, September 2023).
  - The line shows the trend of the highest measured demand each month, which generally increases over time.
- **Notable Styling**: 
  - The bars are in orange.
  - The line is in gray and follows the peaks of the bars.
...
- **Data Points**:
  - The bars show monthly energy usage, with peaks in July 2023 and lower usage in February 2023.
...
068546000040832
$\left.{ }^{\mathrm{H}}\right|_{[1]} \mathrm{H}_{1}\left[{ }^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}}\right] \mathrm{H}_{1}\left[{ }^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}}\right] \mathrm{H}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}}^{\mathrm{H}} \mathrm{H} \mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}} \mathrm{H} \mathrm{H}}^{\mathrm{H}} \mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}} \mathrm{H} \mathrm{I}^{\mathrm{H}} \mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}} \mathrm{I}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}} \mathrm{H}^{\mathrm{H}}
...
- **Legend**:
  ...
  - "E" indicates "Estimated reading."
- **Data Points**:
  - Bars show varying heights for each month, indicating changes in energy usage.
  - The line fluctuates, showing the highest measured demand for each month.
...
- **Styling**: Orange bars are used for energy usage, and a gray line for demand, with estimated readings marked by "E."
...
- **Legend Entries**:
  ...
  - "E" indicates "Estimated reading."
- **Data Points**:
  - Bars show varying energy usage with peaks around Sep 2022, Jul 2023, and Sep 2023.
  - The line shows the highest measured demand each month, peaking around Jul 2023.
- **Styling**: Orange bars for energy usage, gray line for demand, and labels for estimated readings. 
...
- **Data Points**:
  - The bars show varying energy usage each month, with peaks around July and August 2023.
  - The line shows the highest measured demand, which fluctuates but generally trends upwards towards the summer months.
...
- **Legend Entries**:
  ...
  - "E": Estimated reading
- **Data Points**:
  - Each month from Sep 2022 to Sep 2023 has an orange bar representing energy usage.
...
- **Y-Axis (Left)**: Energy usage in kWh, ranging from 0 to 3000.
- **Y-Axis (Right)**: Measured demand in kW, ranging from 0 to 8.
- **Legend**:
  - Orange bars represent "Total energy used."
  - A gray line represents "Highest Measured Demand each month."
  - "E" indicates "Estimated reading."
...
- **Notable Styling**: The bars are in orange, and the line is gray. The estimated readings are marked with "E."

This chart provides a **yearly usage breakdown (monthly-based)**, showing both energy consumption and peak demand over the specified period.
...
- **Legend**:
  - Orange bars: Total energy used
  - Gray line: Highest Measured Demand each month
  - Symbol (E): Estimated reading
- **Data Points**:
  - The bars show varying heights, indicating different levels of energy usage each month.
  - The line graph shows fluctuations in the highest measured demand across the months.
- **Styling**:
  - Orange is used for the bars representing energy usage.
  - A gray line represents the highest measured demand.
  - The estimated reading is indicated by a specific symbol.
...
$\mathrm{J}^{1} \mathrm{HJ}\left[\mathrm{HJ}^{1} \mathrm{HJ}\left[\mathrm{J}^{1} \mathrm{HJ}\left[\mathrm{J}^{1} \mathrm{HJ}\left[\mathrm{J}^{1} \mathrm{HJ}\left[\mathrm{J}^{1} \mathrm{HJ}\left[\mathrm{J}^{1} \mathrm{HJ}\left[\mathrm{J}^{1} \mathrm{HJ}\left[\mathrm{J}^{1} \mathrm{HJ}\right] \mathrm{JHJ}\right] \mathrm{HJ}\right] \mathrm{HJ}\right] \mathrm{HJ}\right] \mathrm{HJ}\right]$ PSE\&G CO
PO BOX 14444
NEW BRUNSWICK NJ 08906-4444
...
- **Chart Type**: Combination of bar and line chart.
- **X-Axis**: Months from September 2022 to September 2023.
- **Y-Axis**: kWh (Kilowatt-hour), ranging from 0 to 3500.
- **Legend Entries**:
  - Orange bars: Total energy used
  - Solid line: Highest Measured Demand each month
  - "E": Estimated reading
- **Data Points**:
  - Bars show total energy used each month, with a noticeable decrease in August and September 2023.
  - The line represents the highest measured demand, which remains relatively stable until a drop in the summer months.
...
- **Legend Entries**:
  ...
  - Estimated reading (indicated by "E")
- **Data Points**: Each month from September 2022 to September 2023 has an orange bar representing the total energy used, with a line indicating the highest measured demand.
- **Yearly Usage Breakdown (Monthly-Based)**: The chart shows the monthly energy usage over a year.
- **Styling**: Orange bars represent the total energy used, and a line represents the highest measured demand each month.
...
- **Legend Entries**:
  ...
  - "E" indicates "Estimated reading".
- **Data Points**:
  - The bars show varying heights, indicating monthly energy usage.
  - The line shows fluctuations in the highest measured demand each month.
- **Yearly Usage Breakdown (Monthly-Based)**: The chart provides a visual representation of energy usage and demand over a year, with notable increases in usage during the summer months.
...
- **Chart Type**: Bar chart with line graph
- **X-Axis**: Months from "Sep 2022" to "Sep 2023"
- **Y-Axis**: Energy usage scale from 0 to 3500
- **Legend**:
  - Orange bars represent "Total energy used"
  - A grey line represents "Highest Measured Demand each month"
  - "E" denotes "Estimated reading"
- **Data Points**:
  - Bars show varying energy usage each month, with a peak in September 2022 and lower usage in August and September 2023.
  - The line graph shows the highest measured demand each month, which fluctuates slightly but remains relatively stable.
- **Yearly Usage Breakdown (Monthly-Based)**: The chart provides a monthly breakdown of energy usage over the year from September 2022 to September 2023.
...
- **Chart Type**: Bar chart
- **X-Axis**: Months from Sep 2022 to Sep 2023
- **Y-Axis**: Energy usage scale from 0 to 8500
- **Legend Entries**:
  - Total energy used
  - Highest Measured Demand each month
  - E Estimated reading
- **Data Points**: Monthly energy usage is represented by orange bars for each month from Sep 2022 to Sep 2023.
- **Notable Styling**: 
  - Orange bars represent "Total energy used."
  - A line indicates "Highest Measured Demand each month."
  - The chart includes a legend with symbols for estimated readings.
- **Yearly Usage Breakdown (Monthly-Based)**: The chart provides a visual representation of energy usage per month over a year.
...
- **Legend Entries**:
  ...
  - "E": Estimated reading
- **Data Points**:
  - Sep 2022: Highest bar, around 5500 kWh
  - Oct 2022: Lower bar, around 2750 kWh
  - Nov 2022 to Feb 2023: Bars remain around 2750 kWh
  - Mar 2023: Slight increase, around 3000 kWh
  - Apr 2023: Higher bar, around 4500 kWh
  - May 2023: Slight decrease, around 3750 kWh
  - Jun 2023 to Sep 2023: Bars increase, reaching around 5000 kWh by Sep 2023
- **Line**: Fluctuates, generally increasing from Sep 2022 to Sep 2023
- **Yearly Usage Breakdown (Monthly-Based)**: The chart provides a visual representation of monthly energy usage and demand over a year.
...
- **Y-Axis (Left)**: Total energy used, ranging from 0 to 8000 kWh.
- **Y-Axis (Right)**: Highest Measured Demand each month, ranging from 0 to 32 kW.
- **Legend**:
  - Orange bars represent "Total energy used."
  - A gray line represents "Highest Measured Demand each month."
  - "E" indicates an "Estimated reading."
- **Data Points**:
  - Energy usage is shown for each month with varying heights of orange bars.
  - The highest measured demand is shown as a gray line that trends upward over the months.
- **Yearly Usage Breakdown (Monthly-Based)**: The chart provides a visual representation of monthly energy usage and demand over the year.
...
| Generation kW | 14,474 |
| :-- | --: |
| Transmission kW | 13,073 |
...
- **Yearly Usage Breakdown (Monthly-Based)**: The chart provides a monthly breakdown of energy usage and demand over a year.
- **Styling**: Orange is used for the bars, and gray for the line, with an "E" marking estimated readings.
...
- **Legend Entries**:
  ...
  - "E" denotes "Estimated reading"
- **Data Points**:
  - Notable peaks in energy usage occur in "Jan 2023" and "May 2023"
  - Other months show relatively lower and more consistent energy usage
- **Styling**:
  - The bars are colored in orange
  - The line indicating the highest measured demand is subtle and runs across the chart
...
The image is a photo or illustration showing two intersecting lines against a plain white background. The lines form an angle, with one line extending diagonally from the top left to the bottom right, and the other extending from the top left towards the center. There is no text or additional elements visible in the image.
...
The image is a combination of text and a bar chart.
...
- The chart shows varying levels of energy usage across the months, with peaks in June, July, and September 2023.
...
The image is a simple illustration showing two intersecting lines forming an "X" shape. One line is slightly curved, while the other is straight. There is no embedded text or additional elements present in the image.
