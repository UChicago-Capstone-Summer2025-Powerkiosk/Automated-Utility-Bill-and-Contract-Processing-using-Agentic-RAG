...
| Account <br> Number | Service <br> Location | Utility | Utility <br> Rate <br> Class | Zone | Capacity / <br> Trans- <br> mission <br> Tags | "Estimated <br> Meter Read <br> Start Date <br> (MM/DD/YYYY) | Purchase <br> Price <br> (cents / kWh) | Annual <br> Historical <br> Usage <br> (kWh) |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| 0852518104 | 2777 WALDEN AVE <br> (API HEAT TRANSFER <br> INC.) | Niagara <br> Mohawk | SC4 | A | 398.1 / N/A | 01/30/2019 | 5.350 | 2,553,836 |
...
Term of Months: $\underline{24}$ Months
...
# ELECTRICITY TRANSACTION CONFIRMATION - NEW YORK FIXED PRICE 100\% MAC 
...
| Tax <br> Exemption <br> Status: | In order to insure accurate billing, tax status indication is required. Please check the appropriate status below: |
| :--: | :--: |
|  | $\left[\_\right.$] Non-Exempt |
|  | $\left[\_\right.$] Exempt (e.g. Residential, Non-Profit Organization, Manufacturing, Small Business, Agricultural, Resale, etc.) |
