...
068534000040838
$\left.\mathrm{If} \mathrm{ll} \mathrm{ll}_{\mathrm{l}} \mathrm{ll}_{\mathrm{l}} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l}_{\mathrm{l}} \mathrm{l}_{\mathrm{l}} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l}_{\mathrm{l}} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l} \mathrm{l}
...
- **Y-Axis** (left side): Energy usage in kWh (0 to 9500)
- **Y-Axis** (right side): Not specified, likely related to demand
- **Legend**:
...
- **Data Points**:
  ...
  - The line graph indicates the highest measured demand each month.
- **Yearly usage breakdown (monthly-based)**: The chart provides a visual representation of energy usage and demand over a year, showing fluctuations in both metrics.
...
The image is a photo or illustration of a blank white page. There is no visible content or elements on the page, except for a small text in the top right corner that reads: "ia.jpeg | 106010.jpg:pub|202302221117 sr=137070-000040838".
...
The image is a bar chart with a line graph overlay. It shows a **yearly usage breakdown (monthly-based)** of electricity usage from September 2022 to September 2023. 
...
Each month has an orange bar indicating energy usage, with a gray line showing the highest demand. The bars are consistent in height, with some variation, and the line fluctuates slightly across the months.
...
- **X-axis**: Months from Sep 2022 to Sep 2023
- **Y-axis (left)**: kWh (0 to 150,000)
- **Y-axis (right)**: kW (0 to 600)
- **Legend**:
  - Orange bars represent "Total energy used"
  - A gray line represents "Highest Measured Demand each month"
  - "E" indicates "Estimated reading"
- **Data Points**:
  - Bars show varying heights, with peaks around Dec 2022 and Jan 2023.
  - The line fluctuates, showing peaks and troughs corresponding to the bar heights.
...
- **Legend Entries:**
  ...
  - The letter "E" above some bars indicates "Estimated reading."
- **Data Points:**
  - Energy usage is consistently high, with notable peaks in October 2022, January 2023, and July 2023.
  - The highest measured demand peaks significantly in February 2023.
- **Styling:**
  - Orange bars for energy usage.
  - Grey line for demand.
  - "E" markers for estimated readings.
...
- **Y-Axis (Left)**: kWh, ranging from 0 to 8000
- **Y-Axis (Right)**: Demand in kW, ranging from 0 to 30
- **Legend**:
  - Orange bars: "Total energy used"
  - Grey line: "Highest Measured Demand each month"
  - "E" indicates "Estimated reading"
- **Data Points**:
  - **Sep 2022**: Energy used ~ 5000 kWh
  - **Oct 2022**: Energy used ~ 3500 kWh
  - **Nov 2022**: Energy used ~ 4000 kWh
  - **Dec 2022**: Energy used ~ 4000 kWh
  - **Jan 2023**: Energy used ~ 4500 kWh
  - **Feb 2023**: Energy used ~ 4000 kWh
  - **Mar 2023**: Energy used ~ 4500 kWh
  - **Apr 2023**: Energy used ~ 4500 kWh
  - **May 2023**: Energy used ~ 5000 kWh
  - **Jun 2023**: Energy used ~ 5500 kWh
  - **Jul 2023**: Energy used ~ 6000 kWh
  - **Aug 2023**: Energy used ~ 6500 kWh
  - **Sep 2023**: Energy used ~ 7900 kWh
- **Styling**: The bars are orange, and the line is grey. The estimated readings are marked with "E".
...
- **Y-axis**: Labeled with values ranging from 0 to 3500, likely representing kilowatt-hours (kWh).
- **Legend**:
  - Orange bars represent "Total energy used."
...
- **Yearly Usage Breakdown (Monthly-Based)**: The chart provides a visual representation of energy usage and demand over a year, with notable peaks in July 2023 for energy usage.
...
- **Data Points**:
  ...
  - The line shows the highest measured demand each month.
- **Yearly Usage Breakdown (Monthly-Based)**: The chart provides a visual representation of energy usage and demand over the course of a year, with monthly data points.
...
- **Legend Entries**:
  ...
  - "E" indicates "Estimated reading."
- **Data Points**:
  - Bars show energy usage for each month, with notable increases in June, July, August, and September 2023.
...
- **Data Points**:
  - The bars show varying energy usage each month, with peaks around December 2022, July 2023, and August 2023.
  - The line shows the highest measured demand, peaking in July 2023.
...
- **Legend Entries**:
  ...
  - "E": Estimated reading
- **Data Points**:
  - Each month has an orange bar representing the total energy used.
  - A gray line indicates the highest measured demand each month.
- **Yearly Usage Breakdown (Monthly-Based)**: The chart shows the monthly energy usage and demand over a year.
- **Styling**: Orange bars for energy usage, a gray line for demand, and a label for estimated readings.
...
- **Legend Entries**:
  ...
  - "E": Estimated reading
- **Data Points**:
  - Bars show varying energy usage across months, with peaks around December 2022, January 2023, and June 2023.
  - The line indicates the highest measured demand, fluctuating slightly but generally between 4 and 6 kW.
- **Styling**: Orange bars for energy usage, grey line for demand, and "E" for estimated readings.
...
$\mathrm{mm}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10}$
$\mathrm{m}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S}^{10} \mathrm{~S
...
- **Data Points**:
  - The bars show varying levels of energy usage each month, with peaks in September 2022 and July 2023.
  - The line shows the highest measured demand each month, with a noticeable peak in July 2023.
- **Styling**: Orange bars are used for energy usage, and a gray line for demand. The estimated readings are marked with an "E."
...
068558000040826
$\left.\cdot\right\|_{1}\left[\left\|\mid 11_{1}\right\|_{1}\left\|\left\|_{1}\right\|_{1}\left\|_{1}\right\|\right] \mid 1_{1}\left\|_{1}\left\|_{1}\right\|_{1}\left\|_{1}\right\|_{1}\left\|_{1}\right\|_{1}\left\|_{1}\right\|_{1}\left\|_{1}\right\|_{1}\right\}$
HOTEL WOODBRIDGE LLC
2022167706
...
$\mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I}^{11} \mathrm{I
...
The chart shows consistent energy usage from September 2022 to June 2023, with a significant drop in July, August, and September 2023. The highest measured demand line remains relatively stable throughout the period.
...
- **Legend**:
  ...
  - "E": Estimated reading
- **Data Points**: Each month has an orange bar representing energy usage, with a black line indicating the highest measured demand.
- **Yearly Usage Breakdown (Monthly-Based)**: The chart shows monthly energy usage over a year, with consistent usage patterns and slight variations in demand.
...
- **Data Points**:
  ...
  - Usage decreases in the following months, with a notable dip in February 2023.
  - Energy usage increases again from May 2023, peaking in August 2023.
  - The highest measured demand line fluctuates, peaking in August 2023.
...
- **Legend**:
  ...
  - "E" indicates "Estimated reading".
- **Data Points**:
  - The bars show varying energy usage each month, with the highest in "Sep 2022" and lower values in "Aug 2023" and "Sep 2023".
  - The line graph shows the highest measured demand each month, which fluctuates slightly over the year.
- **Yearly Usage Breakdown (Monthly-Based)**: The chart provides a monthly breakdown of energy usage over a year, highlighting changes in consumption and demand.
...
The bars show fluctuations in energy usage, with notable peaks in December 2022 and consistent high usage from June to September 2023.
...
- **Data Points**:
  - September 2022: High energy usage, around 5000 kWh.
  - October 2022: Significant drop in usage.
  - November 2022 to February 2023: Relatively stable, lower usage.
  - March 2023: Increase in usage.
  - April 2023: Slight decrease.
  - May 2023: Increase in usage.
  - June to August 2023: High usage, peaking in July.
  - September 2023: High usage, similar to previous September.

- **Styling**: Orange bars represent energy usage, and a gray line represents the highest measured demand each month. The estimated reading is marked with "E".
...
- **Legend**:
  ...
  - "E" indicates "Estimated reading."
- **Data Points**:
  - Bars show varying energy usage each month, with higher usage in the summer months (June, July, August, and September 2023).
  - The line indicates the highest measured demand each month, with peaks aligning with higher usage months.
- **Yearly usage breakdown (monthly-based)**: The chart visually represents monthly energy usage over a year, highlighting seasonal variations in demand and usage.
...
- **Yearly Usage Breakdown (Monthly-Based)**: The chart provides a visual representation of energy usage and demand over a year, with notable peaks and troughs in both energy usage and demand.
...
- **Legend Entries**:
  ...
  - "E" indicates "Estimated reading."
- **Data Points**: 
  - Bars show varying energy usage each month, with peaks in December 2022 and April 2023.
  - The line graph shows the highest measured demand, which fluctuates over the months.
...
- **Styling**: Orange bars for energy usage, a line for demand, and an "E" for estimated readings.
...
- **Data Points**:
  ...
  - Aug 2023: ~15
  - Sep 2023: ~15
- **Notable Styling**: Orange bars represent total energy used, with a line indicating the highest measured demand each month. The estimated readings are marked with an "E".
- **Description**: This chart provides a yearly usage breakdown (monthly-based) of total energy used from September 2022 to September 2023, highlighting the highest measured demand each month.
...
The image appears to be a photo or illustration showing a close-up of a thin, angled line or object against a plain background. The line is dark and slightly curved, extending diagonally from the top left to the bottom right. There are no visible text or additional elements in the image.
...
The bar chart titled "Your monthly electric use" displays:
- **Y-axis**: kWh, ranging from 0 to 15,000
- **X-axis**: Monthly data from September 2022 to September 2023
- **Legend**:
  - Solid bar: Total energy used
  - Line: Highest Measured Demand each month
  - "E" indicates Estimated reading

The chart shows a **yearly usage breakdown (monthly-based)** with varying heights of bars, indicating fluctuations in energy usage throughout the year.
...
The image is a simple illustration consisting of two intersecting lines forming an "X" shape. One line is more vertical, while the other is more horizontal, crossing each other near the center. There is no embedded text or additional elements present in the image.
