...
| Phone: 865-910-3397 <br> (Required) |  |  | Email: <br> (Required) | Laura.switaj@regalcinemas.com |  | Fax: |  |  |
| Address for Notices: Street: 101 E Blount Ave (Required) |  |  | City: <br> (Required) | Knoxville <br> (Required) |  | State: <br> (Required) | TN <br> (Required) | Zip: 37920 <br> (Required) |
...
| Title: | VP, Head of Operations | FREEPOINT ENERGY SOLUTIONS LLC |
| :--: | :--: | :--: |
|  |  | Signature: Date: |
|  |  |  |
|  |  | Name: |
...
|  | Utility <br> Name | Account Number | DBA | Service Address | Estimated Start Date* | Service End Date | Bill Option** | PLC | NSPL | $\begin{gathered} \text { Tax } \\ \text { Exempt } \\ \%^{* * *} \end{gathered}$ |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
...
| 10 | PSEG | PE0000108416793 59145 |  | 1000 CORPORATE CT <br> SIGN, SOUTH <br> PLAINFIELD BORO, NJ 07080 | 01/07/2025 | 12/07/2027 | Utility Consolidated - Bill Ready | 0.72 | 0.58 |  |
