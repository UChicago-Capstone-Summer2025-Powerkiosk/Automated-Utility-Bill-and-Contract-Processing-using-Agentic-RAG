...
| Generation/ Supply Price | \$0.05037/kWh during the Initial Term. |
...
| Contract Start Date | Deliveries of electricity will start on the date set by EDC, during or after 11/1/2021. If you signed up more than one account, please refer to the dates in the Facility Attachment hereto. |
| Contract Duration | The Initial Term will end on the date set by the EDC, during or immediately following 8/1/2022. If you signed up more than one account, please refer to the dates in the Facility Attachment hereto. |
...
| Customer Name: <br> (frequited) |  |  | DBA (if applicable): |  |  |
| :--: | :--: | :--: | :--: | :--: | :--: |
| Customer Contact: |  |  |  |  |  |
| Name: | Timothy Wolfgang <br> (frequited) |  | Title: | CFO <br> (frequited) |  |
| Phone: | 215-581-9179 <br> (frequited) | Email: | Timothy.WGfgang@BelmontBehavioral.com <br> (frequited) |  | Fax: |
| Address for Notices: |  |  |  |  |  |
| Street: | 4200 Monument Rd <br> (frequited) | City: | Philadelphia <br> (frequited) | State: | $\begin{aligned} & \text { P.A } \\ & \text { Freepoint } \end{aligned}$ | Zip: $\begin{aligned} & 19131 \\ & \text { Freepoint } \end{aligned}$ |

Electricity Supply Selection:

| Pricing: $\boxtimes$ Fixed | Price: $\$ 0.05037 / \mathrm{kWh}$ | Cost Components Included in the Price (check if included): <br> Energy Capacity Transmission \&ancillary Services \&Renewables \&MLC \&ARR |
| :--: | :--: | :--: |
