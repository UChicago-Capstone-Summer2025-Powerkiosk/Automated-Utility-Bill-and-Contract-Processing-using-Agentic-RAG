# IL Natural Gas Transaction Confirmation 
...
The image is a photo or illustration of a form section. It contains a box with the initials "ME" in blue text on the left side. To the right of the box, there is the text "Initial to confirm billing method" on a gray background. The box and text are aligned horizontally.
...
[^0]
[^0]:    Customer declines to receive communications about other products and services offers by HES, its affiliates or business partners. Customer will still receive communications relevant to this Agreement.
